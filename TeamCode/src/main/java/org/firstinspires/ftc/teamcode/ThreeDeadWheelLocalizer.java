...
public final class ThreeDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double par0YTicks = -2892.4516255560484; // y position of the first parallel encoder (in tick units)
        public double par1YTicks =  2715.5371612862514; // y position of the second parallel encoder (in tick units)
        public double perpXTicks = 2512.097128899028; // x position of the perpendicular encoder (in tick units)
    }
